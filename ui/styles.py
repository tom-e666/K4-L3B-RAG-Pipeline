...
def inject_styles() -> None:
    st.markdown(
        ...
        div.stButton > button { background:#292c36; border-color:#292c36; color:#fff; }
        div.stButton > button p { color:#fff !important; }
        div.stButton > button:hover { background:#343a49; border-color:#343a49; color:#fff; }
        [data-testid="stChatInput"] { background:#292c36; border-color:#444a57; }
        [data-testid="stChatInput"] > div,
        [data-testid="stChatInput"] textarea { background:#292c36; color:#fff; }
        [data-testid="stChatInput"] textarea::placeholder { color:#cbd5e1; }
