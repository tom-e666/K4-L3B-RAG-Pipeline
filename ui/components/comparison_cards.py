...
def render_document_overlap_matrix(results: dict[str, dict[str, Any]]) -> None:
    ...
    if "Hybrid Search" in results and "Hybrid + Reranker" in results:
        pairs.append(("Hybrid Search", "Hybrid + Reranker"))
...
def render_technique_explanations() -> None:
    ...
    expls = [
        ...
        ("🎯 Reranker", "Đánh giá và dung hợp lại thứ hạng các candidate bằng Reciprocal Rank Fusion (RRF)."),
    ]
